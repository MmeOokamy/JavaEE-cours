...
/*	Cette classe acc�de � une adresse par HTTP ddans un Thread s�par�
 * 	Elle peut �tre utilis�e de fa�on �v�nementielle ou non
 *
 *	Exemple d'utilisation (non �v�nementielle) :
 *  
 ...
 *
 *
 *	Exemple d'utilisation exploitant les �v�nements :
 *	
...
public class HttpClient extends Thread {
	...
	//		�crit les donn�es et lit la r�ponse
    ...
    public void run() {
        ...
        try {
            ...
            // Envoyer les donn�es si m�thode POST :
